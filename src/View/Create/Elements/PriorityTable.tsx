            ...
            return (
              <tr key={key}>
                ...
                {content[key].map((val, index) => {
                  const priorityKey = Object.keys(this.props.priorities)[index];
                  let selectedClass = "";
                  if (
                    this.props.priorities[priorityKey] === (key as PriorityType)
                  )
